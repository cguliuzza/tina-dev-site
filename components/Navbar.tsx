        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a
              ...
              rel={item.rel}
              target={item.target}
              className="text-sm font-normal leading-6 text-slate-600 hover:text-slate-900"
            >
              {item.name}
            </a>
          ))}
              ...
              <div className="space-y-2 py-6">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="-mx-3 block text-center rounded-lg py-2 px-3 text-base font-semibold leading-7 text-slate-600 hover:text-slate-900 hover:bg-slate-50"
                  >
                    {item.name}
                  </a>
                ))}
